...
import json
if __name__ == '__main__': import servo_control
...
def read_gyro():
	...
	x, y, z = read_word_2c(0x43), read_word_2c(0x45), read_word_2c(0x47)
...
with open('gyro_offsets.json', 'r+') as file:
    if __name__ == '__main__':
        ...
        gx_cal, gy_cal, gz_cal = json.load(file)
