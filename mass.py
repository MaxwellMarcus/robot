...
class Joint:
    def __init__(self, x, y, z, anchor, pivot):
        ...
        self.pivot_a = Angle(self.x, self.y, self.z, self.pivot.x, self.pivot.y, self.pivot.z)
        self.anchor_a = Angle(self.x, self.y, self.z, self.anchor.x, self.anchor.y, self.anchor.z)
...
class Angle:
    def __init__(self, x, y, z, x1, y1, z1):
        ...
        self.phi = math.asin(z / r)

        print('theta, phi: ', math.degrees(self.theta), math.degrees(self.phi))
        print('x, y, z: ', self.get_pos(1, 0, 0, 0))
